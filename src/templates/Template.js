    ...
    <div class="About">
      <div class="card">
        ...
        <div class="card_social">
          ...
          <picture>
          <source type="image/webp" srcset="${twitter.replace("png", "webp")}"/>
            <img src="${twitter}" loading="lazy" />
            </picture>
          </a>
          <a href="https://github.com/gndx">
          <picture>
          <source type="image/webp" srcset="${github.replace("png", "webp")}"/>
            <img src="${github}" loading="lazy" />
            </picture>
          </a>
          <a href="https://instagram.com/gndx">
          <picture>
          <source type="image/webp" srcset="${instagram.replace(
            "png",
            "webp"
          )}"/>
